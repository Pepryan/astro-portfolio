...
date: "2025-06-01"
updated: "2025-06-01"
tags: ["n8n", "automation", "deployment", "tutorial", "workflow", "nocode", "devops", "docker", "nginx", "reverse-proxy", "self-hosted"]
draft: false
...
```nginx
server {
    server_name n8n.dzikirapp.my.id;  # Ganti dengan domain kamu
