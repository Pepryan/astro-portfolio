...
### 1. Persiapan Release Files

Pertama, temen-temen perlu download tools yang diperlukan. Dalam tutorial ini, kita bakal pake OKD versi 4.19.0-okd-scos.11:
...
#### Verify NTP pada SNO Node (setelah deployment)
...
# Install OKD
### 9. Prepare OKD Installation Files
...
# Monitor di bastion openshift wait-for
