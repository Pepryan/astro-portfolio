...
twitter:
  ...
  title: "Btrfs Deep Dive: Zero to Expert 🚀"
...
### Experiment 1: Observing Chunk Allocation
...
# After first 1GB
root@btrfs-practice:~# btrfs filesystem usage /mnt/btrfs
Device allocated:              2.52GiB  ← Grew from 536MB
...
**Observation:** Btrfs allocated ~2GB chunk for 1GB of data. Why the extra space?

**Answer:** Performance optimization! Like keeping a parking lot ready:
- Allocating chunks has overhead
- Better to pre-allocate extra space than constantly allocate/deallocate
- Future writes can use the existing chunk = faster

### Experiment 2: Adding More Data
...
**Learning:** Btrfs dynamically allocates chunks on-demand. The first chunk was getting full, so it allocated another 1GB chunk.

### Experiment 3: Space Reclamation
