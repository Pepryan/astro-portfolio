...
category: "Tutorial"
summary: "A comprehensive guide to using Markdown and MDX features including code blocks, tables, and more"
author: "Febryan Ramadhan"
draft: true
difficulty: "Beginner"
keywords: ["markdown", "mdx", "guide", "documentation", "writing"]
openGraph:
  title: "Markdown and MDX Guide"
  description: "A comprehensive guide to using Markdown and MDX features for better documentation."
  type: "article"
twitter:
...
### Images
![Screenshot](/images/image_2024-11-18_15-10-17.webp)
